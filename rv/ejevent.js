...
VENTANA.listener = function() {
  ...
  VENTANA.renderizador.setSize( window.innerWhidth, window.innerHeight); 
}
...
VENTANA.setup = function() {
  ...
  VENTANA.camara = new THREE.PerspectiveCamera( 75, window.innerWidth / window.innerHeight, .1, 1000);
